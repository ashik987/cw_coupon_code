...
<html>
    <head>
        ...
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.css"></script>
    </head>
    ...
    <body>
        <div class="container">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="coupon_code" placeholder="Apply Promocode" name="coupon_code" value="1000.00">
                    ...
                    $.ajax({
                        ...
                        success: function(dataResult){
                            ...
                            if(dataResult.statusCode==200){
                                var after_apply = $('#totale_price').val()-dataResult.value;
